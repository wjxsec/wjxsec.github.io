...
it is accepted only when all synthetic markers match and the decrypted address
is inside one of those documentation ranges. It is never used for a normal
visit. The panel reports how many aggregate events and unique sources
